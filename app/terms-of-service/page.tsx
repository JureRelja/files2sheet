  ...
  return (
    <main className="flex flex-col gap-12 justify-center">
      ...
      <div className="flex flex-col gap-2 w-[1000px] mx-auto">
        ...
        <p>Welcome to files2sheet.com!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of files2sheet.com's Website, located at https://files2sheet.com/.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use files2sheet.com if you do not agree
        ...
        <p>
          We employ the use of cookies. By accessing files2sheet.com, you agreed
          to use cookies in agreement with the files2sheet.com's Privacy Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, files2sheet.com and/or its licensors own the
          intellectual property rights for all material on files2sheet.com. All
          intellectual property rights are reserved. You may access this from
          files2sheet.com for your own personal use subjected to restrictions
          set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from files2sheet.com</li>
          <li>Sell, rent or sub-license material from files2sheet.com</li>
          <li>Reproduce, duplicate or copy material from files2sheet.com</li>
          <li>Redistribute content from files2sheet.com</li>
        </ul>
        ...
        <p>
          ...
          files2sheet.com does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of files2sheet.com,its agents and/or affiliates.
          ...
          files2sheet.com shall not be liable for the Comments or for any
        ...
        <p>
          files2sheet.com reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant files2sheet.com a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of files2sheet.com; and (d) the
        ...
        <p>
          ...
          sending an e-mail to files2sheet.com. Please include your name, your
        ...
        <p>
          No use of files2sheet.com's logo or other artwork will be allowed for
